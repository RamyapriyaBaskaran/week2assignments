...
public class DuplicateLead {
	...
	public static void main(String[] args) {
		...
		//Click on Duplicate Lead->clear and update Company name, first name->Submit
		...
		firstName.clear();
		firstName.sendKeys("Ramyapriya");
		driver.findElement(By.className("smallSubmit")).click();

		//Get the page title and print
		String updatedTitle = driver.getTitle();
		System.out.println("Title of the page after Duplicated Lead is : " +updatedTitle);
